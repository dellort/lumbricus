...
//great XXX (xxx xxx xxx):
//I think there's the theoretical possibility of a deadlock when using the SDL.
//Because we have manual bitmap blitting code (for filling polygons etc.), we
//need to get the pixel data, and thus, we have to lock both the source- and
//destination surfaces. Most likely the SDL will do the same. Because both we
//and the SDL could use a different locking order, a deadlock could occur.

//Although I'm pretty sure this won't happen in reallife.
...
public class LevelRenderer {
    ...
    public abstract void drawBorder(Lexel a, Lexel b, bool do_up, bool do_down,
