...
module derelict.directx.d3dx9;

public import derelict.directx.d3d9;
import derelict.util.loader;
public import tango.sys.win32.Types;
public import tango.sys.win32.IUnknown;
...
extern(Windows)
{
	uint function(uint* pFunction) D3DXGetShaderVersion;
	...
	HRESULT function(
	        ...
	        DWORD                     Usage,
	        D3DFORMAT*                pFormat,
	        D3DPOOL                   Pool) D3DXCheckTextureRequirements;
	...
	HRESULT function(
	        ...
	        D3DFORMAT                 Format,
	        D3DPOOL                   Pool,
	        IDirect3DCubeTexture9*   ppCubeTexture) D3DXCreateCubeTexture;

	HRESULT function(
			LPDIRECT3DDEVICE9 pDevice,
			LPCTSTR pSrcFile,
			LPDIRECT3DTEXTURE9 * ppTexture) D3DXCreateTextureFromFileA;
	...
	HRESULT function(
	        ...
	        IDirect3DTexture9*       ppTexture) D3DXCreateTextureFromFileExA;
	...
	HRESULT function(
	        ...
	        D3DXIMAGE_INFO*           pSrcInfo,
	        PALETTEENTRY*             pPalette,
	        IDirect3DCubeTexture9*   ppCubeTexture) D3DXCreateCubeTextureFromFileExA;
	...
	HRESULT function(
	        ...
	        DWORD MinValue,
	        DWORD Options,
	        ID3DXMesh* ppMesh) D3DXSimplifyMesh;

	HRESULT function(
	        DWORD NumVertices,
	        DWORD FVF,
	        DWORD NumBones,
	        ID3DXSkinInfo* ppSkinInfo) D3DXCreateSkinInfoFVF;

	D3DXVECTOR2* function( D3DXVECTOR2 *pOut, D3DXVECTOR2 *pV, D3DXMATRIX *pM ) D3DXVec2TransformCoord;

	D3DXVECTOR4* function( D3DXVECTOR4 *pOut, D3DXVECTOR3 *pV, D3DXMATRIX *pM ) D3DXVec3Transform;

	D3DXVECTOR3* function( D3DXVECTOR3 *pOut, D3DXVECTOR3 *pV, D3DXMATRIX *pM ) D3DXVec3TransformCoord;

	D3DXVECTOR4* function( D3DXVECTOR4 *pOut, D3DXVECTOR4 *pV, D3DXMATRIX *pM ) D3DXVec4Transform;

	D3DXMATRIX* function( D3DXMATRIX *pOut, D3DXMATRIX *pM ) D3DXMatrixTranspose;

	D3DXMATRIX* function( D3DXMATRIX *pOut, D3DXMATRIX *pM1, D3DXMATRIX *pM2 ) D3DXMatrixMultiply;

	D3DXMATRIX* function( D3DXMATRIX *pOut, FLOAT *pDeterminant, D3DXMATRIX *pM ) D3DXMatrixInverse;

	D3DXMATRIX* function( D3DXMATRIX *pOut, FLOAT sx, FLOAT sy, FLOAT sz ) D3DXMatrixScaling;

	D3DXMATRIX* function( D3DXMATRIX *pOut, FLOAT x, FLOAT y, FLOAT z ) D3DXMatrixTranslation;

	D3DXMATRIX* function( D3DXMATRIX *pOut, FLOAT Angle ) D3DXMatrixRotationX;

	D3DXMATRIX* function( D3DXMATRIX *pOut, FLOAT Angle ) D3DXMatrixRotationY;

	D3DXMATRIX* function( D3DXMATRIX *pOut, FLOAT Angle ) D3DXMatrixRotationZ;

	D3DXMATRIX* function( D3DXMATRIX *pOut, D3DXQUATERNION *pQ) D3DXMatrixRotationQuaternion;

	D3DXMATRIX* function( D3DXMATRIX *pOut, FLOAT Yaw, FLOAT Pitch, FLOAT Roll ) D3DXMatrixRotationYawPitchRoll;

	D3DXMATRIX* function( D3DXMATRIX *pOut, FLOAT Scaling, D3DXVECTOR2 *pRotationCenter,
	      float Rotation, D3DXVECTOR2 *pTranslation) D3DXMatrixAffineTransformation2D;

	D3DXMATRIX* function( D3DXMATRIX *pOut, FLOAT fovy, FLOAT Aspect, FLOAT zn, FLOAT zf ) D3DXMatrixPerspectiveFovLH;

	D3DXMATRIX* function( D3DXMATRIX *pOut, FLOAT w, FLOAT h, FLOAT zn, FLOAT zf ) D3DXMatrixOrthoLH;

	D3DXMATRIX* function( D3DXMATRIX *pOut, FLOAT l, FLOAT r, FLOAT b, FLOAT t, FLOAT zn,
	      FLOAT zf ) D3DXMatrixOrthoOffCenterLH;

	void function( D3DXQUATERNION *pQ, D3DXVECTOR3 *pAxis, FLOAT *pAngle ) D3DXQuaternionToAxisAngle;

	D3DXQUATERNION* function( D3DXQUATERNION *pOut, D3DXMATRIX *pM) D3DXQuaternionRotationMatrix;

	D3DXQUATERNION* function( D3DXQUATERNION *pOut, D3DXQUATERNION *pQ ) D3DXQuaternionNormalize;
	...
	HRESULT function(
	        ...
	        ID3DXBuffer*                   ppCompilationErrors) D3DXCreateEffectFromFileA;

	D3DXMATRIX* function( D3DXMATRIX *pOut, D3DXVECTOR2 *pScalingCenter,
      float *pScalingRotation, D3DXVECTOR2 *pScaling,
      D3DXVECTOR2 *pRotationCenter, float Rotation,
      D3DXVECTOR2 *pTranslation) D3DXMatrixTransformation2D;
    ...
    HRESULT function(
        ...
        DWORD *pNumMaterials,
        ID3DXMesh *ppMesh) D3DXLoadMeshFromXA;
    ...
    HRESULT function(
        ...
        UINT                Sides,
        ID3DXMesh*         ppMesh,
        ID3DXBuffer*       ppAdjacency) D3DXCreatePolygon;
	...
	HRESULT function(
	        ...
	        FLOAT               Depth,
	        ID3DXMesh*         ppMesh,
	        ID3DXBuffer*       ppAdjacency) D3DXCreateBox;
	...
	HRESULT function(
	        ...
	        UINT                Stacks,
	        ID3DXMesh*         ppMesh,
	        ID3DXBuffer*       ppAdjacency) D3DXCreateCylinder;
	...
	HRESULT function(
	        ...
	        UINT               Stacks,
	        ID3DXMesh*        ppMesh,
	        ID3DXBuffer*      ppAdjacency) D3DXCreateSphere;
	...
	HRESULT function(
	        ...
	        UINT                Rings,
	        ID3DXMesh*         ppMesh,
	        ID3DXBuffer*       ppAdjacency) D3DXCreateTorus;

	HRESULT function(
	        IDirect3DDevice9   pDevice,
	        ID3DXMesh*         ppMesh,
	        ID3DXBuffer*       ppAdjacency) D3DXCreateTeapot;
	...
	HRESULT function(
		...
		LPCTSTR pFacename,
		ID3DXFont *ppFont) D3DXCreateFontA;

	HRESULT function(
        IDirect3DDevice9   pDevice,
        ID3DXSprite*       ppSprite) D3DXCreateSprite;
    ...
    HRESULT function(
        ...
        ID3DXEffectPool                 pPool,
        ID3DXEffect*                    ppEffect,
        ID3DXBuffer*                    ppCompilationErrors) D3DXCreateEffect;

    HRESULT function(
        ID3DXEffectPool* pEffectPool) D3DXCreateEffectPool;

    HRESULT function(
		DWORD* pFunction,
		D3DXSEMANTIC* pSemantics,
		UINT* pCount) D3DXGetShaderInputSemantics;
	...
	HRESULT function(
        ...
        ID3DXMesh* ppMesh) D3DXCreateMeshFVF;

    UINT function(DWORD FVF) D3DXGetFVFVertexSize;

    HRESULT function(ID3DXFile* lplpDirectXFile) D3DXFileCreate;
    ...
    HRESULT function(
        ...
        ID3DXBuffer *ppEffectInstances,
        DWORD *pNumMaterials,
        ID3DXMesh *ppMesh) D3DXLoadMeshFromXof;
    ...
    HRESULT function(
	    ...
	    IDirect3DDevice9 pD3DDevice,
	    ID3DXMesh * ppMeshOut) D3DXConcatenateMeshes;

	HRESULT function(DWORD FVF, D3DVERTEXELEMENT9* Declaration) D3DXDeclaratorFromFVF;

	D3DXQUATERNION* function(D3DXQUATERNION* pOut, D3DXQUATERNION* pQ1, D3DXQUATERNION* pQ2, float t) D3DXQuaternionSlerp;

	D3DXVECTOR3* function(D3DXVECTOR3 *pOut, D3DXVECTOR3 *pV0, D3DXVECTOR3 *pV1, D3DXVECTOR3 *pV2, D3DXVECTOR3 *pV3, float s) D3DXVec3CatmullRom;

	void function(  D3DXQUATERNION *pAOut,
								    D3DXQUATERNION *pBOut,
								    D3DXQUATERNION *pCOut,
								    D3DXQUATERNION *pQ0,
								    D3DXQUATERNION *pQ1,
								    D3DXQUATERNION *pQ2,
								    D3DXQUATERNION *pQ3) D3DXQuaternionSquadSetup;

	D3DXQUATERNION* function(D3DXQUATERNION *pOut,
									    D3DXQUATERNION *pQ1,
									    D3DXQUATERNION *pA,
									    D3DXQUATERNION *pB,
									    D3DXQUATERNION *pC,
									    float t) D3DXQuaternionSquad;

	HRESULT function(D3DXVECTOR3 *pOutScale,
...
private void load(SharedLib lib) {
    *cast(void**)&D3DXGetShaderVersion = Derelict_GetProc(lib, "D3DXGetShaderVersion");
    *cast(void**)&D3DXCheckTextureRequirements = Derelict_GetProc(lib, "D3DXCheckTextureRequirements");
    *cast(void**)&D3DXCreateTexture = Derelict_GetProc(lib, "D3DXCreateTexture");
    *cast(void**)&D3DXCreateCubeTexture = Derelict_GetProc(lib, "D3DXCreateCubeTexture");
    *cast(void**)&D3DXCreateTextureFromFileA = Derelict_GetProc(lib, "D3DXCreateTextureFromFileA");
    *cast(void**)&D3DXCreateTextureFromFileExA = Derelict_GetProc(lib, "D3DXCreateTextureFromFileExA");
    *cast(void**)&D3DXCreateCubeTextureFromFileExA = Derelict_GetProc(lib, "D3DXCreateCubeTextureFromFileExA");
    *cast(void**)&D3DXSimplifyMesh = Derelict_GetProc(lib, "D3DXSimplifyMesh");
    *cast(void**)&D3DXCreateSkinInfoFVF = Derelict_GetProc(lib, "D3DXCreateSkinInfoFVF");
    *cast(void**)&D3DXVec2TransformCoord = Derelict_GetProc(lib, "D3DXVec2TransformCoord");
    *cast(void**)&D3DXVec3Transform = Derelict_GetProc(lib, "D3DXVec3Transform");
    *cast(void**)&D3DXVec3TransformCoord = Derelict_GetProc(lib, "D3DXVec3TransformCoord");
    *cast(void**)&D3DXVec4Transform = Derelict_GetProc(lib, "D3DXVec4Transform");
    *cast(void**)&D3DXMatrixTranspose = Derelict_GetProc(lib, "D3DXMatrixTranspose");
    *cast(void**)&D3DXMatrixMultiply = Derelict_GetProc(lib, "D3DXMatrixMultiply");
    *cast(void**)&D3DXMatrixInverse = Derelict_GetProc(lib, "D3DXMatrixInverse");
    *cast(void**)&D3DXMatrixScaling = Derelict_GetProc(lib, "D3DXMatrixScaling");
    *cast(void**)&D3DXMatrixTranslation = Derelict_GetProc(lib, "D3DXMatrixTranslation");
    *cast(void**)&D3DXMatrixRotationX = Derelict_GetProc(lib, "D3DXMatrixRotationX");
    *cast(void**)&D3DXMatrixRotationY = Derelict_GetProc(lib, "D3DXMatrixRotationY");
    *cast(void**)&D3DXMatrixRotationZ = Derelict_GetProc(lib, "D3DXMatrixRotationZ");
    *cast(void**)&D3DXMatrixRotationQuaternion = Derelict_GetProc(lib, "D3DXMatrixRotationQuaternion");
    *cast(void**)&D3DXMatrixRotationYawPitchRoll = Derelict_GetProc(lib, "D3DXMatrixRotationYawPitchRoll");
    *cast(void**)&D3DXMatrixAffineTransformation2D = Derelict_GetProc(lib, "D3DXMatrixAffineTransformation2D");
    *cast(void**)&D3DXMatrixPerspectiveFovLH = Derelict_GetProc(lib, "D3DXMatrixPerspectiveFovLH");
    *cast(void**)&D3DXMatrixOrthoLH = Derelict_GetProc(lib, "D3DXMatrixOrthoLH");
    *cast(void**)&D3DXMatrixOrthoOffCenterLH = Derelict_GetProc(lib, "D3DXMatrixOrthoOffCenterLH");
    *cast(void**)&D3DXQuaternionToAxisAngle = Derelict_GetProc(lib, "D3DXQuaternionToAxisAngle");
    *cast(void**)&D3DXQuaternionRotationMatrix = Derelict_GetProc(lib, "D3DXQuaternionRotationMatrix");
    *cast(void**)&D3DXQuaternionNormalize = Derelict_GetProc(lib, "D3DXQuaternionNormalize");
    *cast(void**)&D3DXPlaneNormalize = Derelict_GetProc(lib, "D3DXPlaneNormalize");
    *cast(void**)&D3DXCreateEffectFromFileA = Derelict_GetProc(lib, "D3DXCreateEffectFromFileA");
    *cast(void**)&D3DXMatrixTransformation2D = Derelict_GetProc(lib, "D3DXMatrixTransformation2D");
    *cast(void**)&D3DXLoadMeshFromXA = Derelict_GetProc(lib, "D3DXLoadMeshFromXA");
    *cast(void**)&D3DXCreatePolygon = Derelict_GetProc(lib, "D3DXCreatePolygon");
    *cast(void**)&D3DXCreateBox = Derelict_GetProc(lib, "D3DXCreateBox");
    *cast(void**)&D3DXCreateCylinder = Derelict_GetProc(lib, "D3DXCreateCylinder");
    *cast(void**)&D3DXCreateSphere = Derelict_GetProc(lib, "D3DXCreateSphere");
    *cast(void**)&D3DXCreateTorus = Derelict_GetProc(lib, "D3DXCreateTorus");
    *cast(void**)&D3DXCreateTeapot = Derelict_GetProc(lib, "D3DXCreateTeapot");
    *cast(void**)&D3DXCreateFontA = Derelict_GetProc(lib, "D3DXCreateFontA");
    *cast(void**)&D3DXCreateSprite = Derelict_GetProc(lib, "D3DXCreateSprite");
    *cast(void**)&D3DXCreateEffect = Derelict_GetProc(lib, "D3DXCreateEffect");
    *cast(void**)&D3DXCreateEffectPool = Derelict_GetProc(lib, "D3DXCreateEffectPool");
    *cast(void**)&D3DXGetShaderInputSemantics = Derelict_GetProc(lib, "D3DXGetShaderInputSemantics");
    *cast(void**)&D3DXCreateMeshFVF = Derelict_GetProc(lib, "D3DXCreateMeshFVF");
    *cast(void**)&D3DXGetFVFVertexSize = Derelict_GetProc(lib, "D3DXGetFVFVertexSize");
    *cast(void**)&D3DXFileCreate = Derelict_GetProc(lib, "D3DXFileCreate");
    *cast(void**)&D3DXLoadMeshFromXof = Derelict_GetProc(lib, "D3DXLoadMeshFromXof");
    *cast(void**)&D3DXConcatenateMeshes = Derelict_GetProc(lib, "D3DXConcatenateMeshes");
    *cast(void**)&D3DXDeclaratorFromFVF = Derelict_GetProc(lib, "D3DXDeclaratorFromFVF");
    *cast(void**)&D3DXQuaternionSlerp = Derelict_GetProc(lib, "D3DXQuaternionSlerp");
    *cast(void**)&D3DXVec3CatmullRom = Derelict_GetProc(lib, "D3DXVec3CatmullRom");
    *cast(void**)&D3DXQuaternionSquadSetup = Derelict_GetProc(lib, "D3DXQuaternionSquadSetup");
    *cast(void**)&D3DXQuaternionSquad = Derelict_GetProc(lib, "D3DXQuaternionSquad");
