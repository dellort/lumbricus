...
private void load(SharedLib lib) {
    bindFunc(D3DXGetShaderVersion)("D3DXGetShaderVersion",lib);
    bindFunc(D3DXCheckTextureRequirements)("D3DXCheckTextureRequirements",lib);
    bindFunc(D3DXCreateTexture)("D3DXCreateTexture",lib);
    bindFunc(D3DXCreateCubeTexture)("D3DXCreateCubeTexture",lib);
    bindFunc(D3DXCreateTextureFromFileA)("D3DXCreateTextureFromFileA",lib);
    bindFunc(D3DXCreateTextureFromFileExA)("D3DXCreateTextureFromFileExA",lib);
    bindFunc(D3DXCreateCubeTextureFromFileExA)("D3DXCreateCubeTextureFromFileExA",lib);
    bindFunc(D3DXSimplifyMesh)("D3DXSimplifyMesh",lib);
    bindFunc(D3DXCreateSkinInfoFVF)("D3DXCreateSkinInfoFVF",lib);
    bindFunc(D3DXVec2TransformCoord)("D3DXVec2TransformCoord",lib);
    bindFunc(D3DXVec3Transform)("D3DXVec3Transform",lib);
    bindFunc(D3DXVec3TransformCoord)("D3DXVec3TransformCoord",lib);
    bindFunc(D3DXVec4Transform)("D3DXVec4Transform",lib);
    bindFunc(D3DXMatrixTranspose)("D3DXMatrixTranspose",lib);
    bindFunc(D3DXMatrixMultiply)("D3DXMatrixMultiply",lib);
    bindFunc(D3DXMatrixInverse)("D3DXMatrixInverse",lib);
    bindFunc(D3DXMatrixScaling)("D3DXMatrixScaling",lib);
    bindFunc(D3DXMatrixTranslation)("D3DXMatrixTranslation",lib);
    bindFunc(D3DXMatrixRotationX)("D3DXMatrixRotationX",lib);
    bindFunc(D3DXMatrixRotationY)("D3DXMatrixRotationY",lib);
    bindFunc(D3DXMatrixRotationZ)("D3DXMatrixRotationZ",lib);
    bindFunc(D3DXMatrixRotationQuaternion)("D3DXMatrixRotationQuaternion",lib);
    bindFunc(D3DXMatrixRotationYawPitchRoll)("D3DXMatrixRotationYawPitchRoll",lib);
    bindFunc(D3DXMatrixAffineTransformation2D)("D3DXMatrixAffineTransformation2D",lib);
    bindFunc(D3DXMatrixPerspectiveFovLH)("D3DXMatrixPerspectiveFovLH",lib);
    bindFunc(D3DXMatrixOrthoLH)("D3DXMatrixOrthoLH",lib);
    bindFunc(D3DXMatrixOrthoOffCenterLH)("D3DXMatrixOrthoOffCenterLH",lib);
    bindFunc(D3DXQuaternionToAxisAngle)("D3DXQuaternionToAxisAngle",lib);
    ...
    bindFunc(D3DXCreatePolygon)("D3DXCreatePolygon",lib);
    bindFunc(D3DXCreateBox)("D3DXCreateBox",lib);
    bindFunc(D3DXCreateCylinder)("D3DXCreateCylinder",lib);
    bindFunc(D3DXCreateSphere)("D3DXCreateSphere",lib);
    bindFunc(D3DXCreateTorus)("D3DXCreateTorus",lib);
    bindFunc(D3DXCreateTeapot)("D3DXCreateTeapot",lib);
    bindFunc(D3DXCreateFontA)("D3DXCreateFontA",lib);
    bindFunc(D3DXCreateSprite)("D3DXCreateSprite",lib);
    bindFunc(D3DXCreateEffect)("D3DXCreateEffect",lib);
    bindFunc(D3DXCreateEffectPool)("D3DXCreateEffectPool",lib);
    bindFunc(D3DXGetShaderInputSemantics)("D3DXGetShaderInputSemantics",lib);
    bindFunc(D3DXCreateMeshFVF)("D3DXCreateMeshFVF",lib);
    bindFunc(D3DXGetFVFVertexSize)("D3DXGetFVFVertexSize",lib);
    bindFunc(D3DXFileCreate)("D3DXFileCreate",lib);
    bindFunc(D3DXLoadMeshFromXof)("D3DXLoadMeshFromXof",lib);
    bindFunc(D3DXConcatenateMeshes)("D3DXConcatenateMeshes",lib);
    bindFunc(D3DXDeclaratorFromFVF)("D3DXDeclaratorFromFVF",lib);
    bindFunc(D3DXQuaternionSlerp)("D3DXQuaternionSlerp",lib);
    bindFunc(D3DXVec3CatmullRom)("D3DXVec3CatmullRom",lib);
    bindFunc(D3DXQuaternionSquadSetup)("D3DXQuaternionSquadSetup",lib);
    bindFunc(D3DXQuaternionSquad)("D3DXQuaternionSquad",lib);
    bindFunc(D3DXMatrixDecompose)("D3DXMatrixDecompose",lib);
    bindFunc(D3DXQuaternionRotationYawPitchRoll)("D3DXQuaternionRotationYawPitchRoll",lib);
    bindFunc(D3DXGetDeclVertexSize)("D3DXGetDeclVertexSize",lib);
}
