...
-- xxx the following should probably be moved into some sort of wwp base plugin
-- same applies to napalm at the start of the file
...
do -- depends from napalm
    ...
    addSpriteClassEvent(s, "sprite_zerohp", function(sender)
        ...
        spawnCluster(standard_napalm, sender, 40, 0, 0, 60)
    end)
end
